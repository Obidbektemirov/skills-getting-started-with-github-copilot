...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice fundamentals, scrimmages and local tournaments",
    ...
    "Debate Team": {
        "description": "Prepare for debate tournaments, develop public speaking and argumentation skills",
